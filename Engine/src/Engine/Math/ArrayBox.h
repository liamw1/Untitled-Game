...
namespace eng::math
{
  ...
  public:
    ...
    T& operator[](IntType index) { return const_cast<T&>(static_cast<const ArrayBoxStrip*>(this)->operator[](index)); }
  ...
  */
  ...
  public:
    ...
    T& operator()(const IVec3<IntType>& index) { return const_cast<T&>(static_cast<const ArrayBox*>(this)->operator()(index)); }
