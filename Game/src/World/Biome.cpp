...
void Biome::StandardColumnFill(Chunk::ArrayBox<Block::Type>::Strip column, length_t chunkFloor, length_t elevation, Block::Type surfaceType, int surfaceDepth, Block::Type soilType, int soilDepth)
{
