...
class ChunkManager
{
  ...
  eng::MultiDrawArray<ChunkDrawCommand> m_OpaqueMultiDrawArray;
  eng::MultiDrawArray<ChunkDrawCommand> m_TransparentMultiDrawArray;
...
private:
  ...
  */
  ...
  void uploadMeshes(eng::thread::UnorderedSet<ChunkDrawCommand>& commandQueue, eng::MultiDrawArray<ChunkDrawCommand>& multiDrawArray);
