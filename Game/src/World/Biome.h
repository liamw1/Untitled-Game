...
public:
  ...
  virtual void fillColumn(ArrayBoxStrip<Block::Type, blockIndex_t, 0, Chunk::Size()> column, length_t chunkFloor, length_t elevation) const = 0;
...
protected:
  ...
  static void StandardColumnFill(ArrayBoxStrip<Block::Type, blockIndex_t, 0, Chunk::Size()> column, length_t chunkFloor, length_t elevation, Block::Type surfaceType, int surfaceDepth, Block::Type soilType, int soilDepth);
