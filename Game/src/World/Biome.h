...
public:
  ...
  virtual void fillColumn(Chunk::ArrayBox<Block::Type>::Strip column, length_t chunkFloor, length_t elevation) const = 0;
...
protected:
  ...
  static void StandardColumnFill(Chunk::ArrayBox<Block::Type>::Strip column, length_t chunkFloor, length_t elevation, Block::Type surfaceType, int surfaceDepth, Block::Type soilType, int soilDepth);
